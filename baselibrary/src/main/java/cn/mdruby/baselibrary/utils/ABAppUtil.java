...
//                    Logger.d(TAG, "前台程序: " + appProcess.processName);
    ...
    /**
     * 检测手机是否含有导航栏 navigation bar
     * @param context
     * @return 有导航栏返回true  否则返回false
     */
    ...
    public static Properties collectDeviceInfo(Context context) {
        ...
        try {
            ...
            if (pi != null) {
                ...
                // as specified by the <manifest> tag'FileUtil versionName attribute.
                mDeviceCrashInfo.put(VERSION_NAME, pi.versionName == null ? "not set" : pi.versionName);
                // public int versionCode The version number of this package,
                // as specified by the <manifest> tag'FileUtil versionCode attribute.
...
//    }
    ...
    public static String getTaskActivityName(Context context){
