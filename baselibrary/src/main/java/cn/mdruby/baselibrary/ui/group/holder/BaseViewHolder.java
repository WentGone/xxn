package cn.mdruby.baselibrary.ui.group.holder;
...
//        setVisibility(isVisible,param);
        setVisibility(isVisible,itemView);
    }


    public void setVisibility(boolean isVisible, ViewGroup.LayoutParams param){
        if (isVisible) {
